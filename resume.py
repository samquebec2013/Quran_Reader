...
def scan_project(project_path):
    ...
    return '\n'.join(summary), source_files, json_files
...
summary_text, source_files, json_files = scan_project(project_root)
...
# Concaténer le code source non JSON
output_code_file = 'code_source.txt'
concatenate_source_code(source_files, output_code_file)

# Concaténer les fichiers JSON
output_json_file = 'code_source_jsonData.txt'
concatenate_source_code(json_files, output_json_file)
